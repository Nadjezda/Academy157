...
public class SortsUtilsGeneric<T extends Comparable <T>> {
    private String sort(T [] arr, Comparator <T> comparator) {//пузырьковая сортиторка
    ...
    private String shake(T [] arr, Comparator <T> comparator)  {// шейкерная сортировка
        int left = 0;
