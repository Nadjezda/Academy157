...
public class SearchEnginePunctuationNormalizerTest {
    ...
    ISearchEngine esDecorated = new SearchEnginePunctuationNormalizer(es);

    @Test
    @DisplayName("Проверяем слово учить")
    public void seache() {
        Assertions.assertEquals(1,
                esDecorated.search("Я люблю учиться, а ты как? Любишь учить?", " учить "));
    }
    ...
    public void seache1() {
        Assertions.assertEquals(0,
                esDecorated.search("Я люблю учиться, а ты как?", " мел "));
    }
    ...
    public void searchAll (){
        ...
        Assertions.assertEquals(12, esDecorated.search("!@#$%^&*()", " "));
        Assertions.assertEquals(0, esDecorated.search("", " а "));
        Assertions.assertEquals(7, esDecorated.search("     ", " "));
